...
//                .isInstanceOf(ResourceNotExistsAssociationException.class);
    ...
    public void update_ThrowsException_WhenLocationAndGivenAreaAlreadyExist() {
        ...
        //exception assertion withou catchThrowable()
//        assertThatThrownBy(() -> areaService.update(locationId, areaId, areaCreateDto))
//                .isInstanceOf(ResourceAlreadyExistsException.class);
        ResourceAlreadyExistsException exception = (ResourceAlreadyExistsException) catchThrowable(() -> areaService.update(locationId, areaId, areaCreateDto));
    ...
    public void delete_ThrowsException_WhenAreaDoesNotExist() {
        ...
        //exception assertion without catchThrowable()
//        assertThatThrownBy(() -> areaService.delete(locationId, areaId))
//                .isInstanceOf(ResourceNotFoundException.class);
        ResourceNotFoundException exception = (ResourceNotFoundException) catchThrowable(() -> areaService.delete(locationId, areaId));
...
//                .isInstanceOf(ResourceReferentialIntegrityException.class);
    ...
    public void findById_ThrowsException_WhenAreaDoesNotExist() {
        ...
        //exception assertion without using catchThrowable() but assertThatThrownBy()
//        assertThatThrownBy(() -> areaService.findById(locationId, areaId))
//                .isInstanceOf(ResourceNotFoundException.class);
        ResourceNotFoundException exception = (ResourceNotFoundException) catchThrowable(() -> areaService.findById(locationId, areaId));
...
//        assertThatThrownBy(() -> areaService.findById(locationId, areaId))
//                .isInstanceOf(ResourceNotExistsAssociationException.class);
        ResourceNotExistsAssociationException exception = (ResourceNotExistsAssociationException) catchThrowable(() -> areaService.findById(locationId, areaId));
