...
public enum BusinessRuleType {
    ...
    SESSION_SCHEDULE_EXECUTION_START_IS_EQUALS_TO_EXECUTION_END("Não é possível criar horário(s) de sessão em que a data de início de execução é igual a data de finalização"),
