...
public class RegistrationServiceTest {
    ...
    public void create_ThrowsException_WhenCurrentUserHasNoPermissionForEvent() {
        ...
        mocksAuthenticationWithJwtUserDetailsThatIsNotAuthorized();
    ...
    public void create_ThrowsException_WhenAccountDoesNotExist() {
        ...
        UUID activityId = registrationConfirmedStatus.getSession().getActivity().getId();
        UUID sessionId = registrationConfirmedStatus.getSession().getId();
        mocksAuthenticationWithJwtUserDetailsThatIsOrganizer(eventId);
    ...
    private void mocksAuthenticationWithJwtUserDetailsThatIsOrganizer(UUID eventId) {
    ...
    private void mocksAuthenticationWithJwtUserDetailsThatIsNotAuthorized() {
