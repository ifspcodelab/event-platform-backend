...
public enum BusinessRuleType {
    ...
    UPDATE_SESSION_SCHEDULE_EXECUTION_IN_REGISTRATION_PERIOD("Não é possível editar o horário de execução de uma ou mais sessão depois que o período de inscrição do evento já tenha iniciado");
