...
public enum BusinessRuleType {
    ...
    SESSION_UPDATE_WITH_AN_ACTIVITY_WITH_CANCELED_STATUS("Não é possível editar uma sessão com uma atividade cancelada"),
    SESSION_UPDATE_WITH_SESSION_SCHEDULE_EXECUTION_IN_REGISTRATION_PERIOD("Não é possível editar o horário de execução de uma ou mais sessão depois que o período de inscrição do evento já tenha iniciado"),
    SESSION_CANCEL_WITH_CANCELED_STATUS("Não é possível cancelar uma sessão que está cancelada"),
    ...
    SESSION_CANCEL_BEFORE_EVENT_REGISTRATION_PERIOD("Não é possível cancelar uma sessão antes que o período de inscrição tenha iniciado"),
    ...
    SESSION_SCHEDULE_EXECUTION_BEFORE_SUBEVENT_EXECUTATION("Data de início de um ou mais horário da sessão é anterior à data de início do subevento"),
    SESSION_SCHEDULE_EXECUTION_AFTER_SUBEVENT_EXECUTATION("A data de fim de um ou mais horário da sessão é posterior à data de fim do subevento"),
    SESSION_SCHEDULE_EXECUTION_START_IS_AFTER_EXECUTION_END("A data de início de execução de um ou mais horário da sessão é posterior a data de finalização"),
